...
**Status:** Superseded by [ADR-0004](0004-aesop-driven-hoare.md).
...
The bespoke `hoare` macro has since been replaced by Aesop's general-purpose proof search with a dedicated `BitcHoare` rule set; see ADR-0004.
